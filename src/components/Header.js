  ...
  return (
    <div className='rectangle'>
      <div className='frame'>
        ...
        <img className='header-image' style={{position:'absolute', right:'-80px',top: '55px'}} src={group} alt="" />
        <img className='header-image-1' style={{position:'absolute', left:'-80px', bottom:'100px'}} src={group} alt="" />
          <Link
            to="/services"
