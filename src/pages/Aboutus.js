...
const AboutUs = () => {
  ...
  <h2 style={{ fontSize: "20px" }} className="font-semibold about-title mb-2">
  ...
  <p className="about-text max-w-4xl mb-2">
    ...
    customers
    <span className="hidden md:inline"> <br /> </span>
    and have built strong ties with our government and private
    sector partners.
  </p>
  <p className="about-text max-w-4xl">
    We have internationally skilled business experts and engineers
    <span className="hidden md:inline"> <br /> </span>
    ready to provide exceptional services to clients in various industries.
  </p>
</div>
