...
const AboutUs = () => {
  return (
    <div className="relative bg-cover bg-center min-h-screen"  style={{ backgroundImage: `url(${background})` ,    opacity: '0.9' }}>
     <img className='about-us-image' style={{position:'absolute', right:'0', zIndex:'2'}} src={group} alt="" />
     <img className='about-us-image-1' style={{position:'absolute', left:'0', zIndex:'2', bottom:'10px'}} src={group} alt="" />
      ...
      <div className="relative z-10 md:w-1/2 flex flex-col items-left justify-center text-white px-4 py-16 md:px-10 lg:px-20">
        ...
        <h2 style={{fontSize:'20px'}} className=" font-semibold about-title mb-2">Innovation and technology should simplify life.</h2>
