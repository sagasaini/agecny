    ...
    <>
      ...
      <div style={{height:'100%'}} className="mask-group"></div>
        ...
        <div
          ...
          className="relative electro-heading  text-white p-4   md:p-8 lg:p-8 text-left"
        >
          <h1 style={{ fontSize: "35px" }} className="it-title md:ml-8 lg:ml-16 font-bold">
            Consulting
          </h1>
          <p
            style={{ fontSize: "48px" }}
      ...
      <div className="data-management container">
        <img
          ...
          alt=""
        />
        <h2 className="data-management-title pl-16">Data Management & Engineering</h2>
        <p className="data-management-description pl-16">
        ...
        <p className="data-management-aim pl-16">
