...
const Home = () => {
  return (
  <Link to="/services">  <main className="relative bg-cover bg-center "  style={{ backgroundImage: `url(${background})` ,    opacity: '0.9' , height:'125vh'}}>
    ...
    <img className='home-image' style={{position:'absolute', left:'0', bottom:'0', display:'none'}} src={group} alt="" />
      ...
      <div style={{position :'absolute', bottom:'40px'}} className="relative z-10  text-white p-4 md:p-8 lg:p-8 text-left">
        <h1 style={{fontSize:'49px'}} className="text-4xl home-header font-bold">GET THE LATEST IN TECHNOLOGY</h1>
        <h2 style={{fontSize:'39px'}} className="text-2xl home-title mt-2">FOR YOUR BUSINESS</h2>
        <p style={{fontSize:'26px' , width:'50%'}} className="mt-4 home-description align-left">
